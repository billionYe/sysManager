    ...
    <div class="box png">
		...
		<div class="input">
			...
			action="${pageContext.servletContext.contextPath }/submitlogin.html">
				这是MOBILE 界面 ！
				<div class="name">
					<label>mobile用户名</label><input type="text" class="text" id="username" placeholder="用户名" name="username" tabindex="1">
				</div>
				<div class="pwd">
					<label>mobile密　码</label><input type="password" class="text" id="password" placeholder="密码" name="password" tabindex="2">
