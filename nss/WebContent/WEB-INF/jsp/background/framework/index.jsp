  ...
  <div style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:0px; PADDING-TOP:0px; WIDTH:100%; HEIGHT:148px; border:1px solid #cacaca;background: #FFFFFF">
	   ...
	   <iframe width="400" scrolling="no" height="120" frameborder="0" allowtransparency="true" src="http://i.tianqi.com/index.php?c=code&id=19&bgc=%23FFFFFF&bdc=%23&icon=1&temp=1&num=2"></iframe>
				...
				<div id="part1" class="leaf one">
					...
					<div class="skin">
						<div style="font-size: 14px;text-align: left;padding: 10px;">
							fly管理系统:<br>
							fly管理系统主要针对服务器和计算机的磁盘，cpu，内存的状态进行显示方便用户管理。<br>
							同时可以设置预警提示。并且拥有完善的用户以及权限管理功能。
							还拥有操作日志的查看功能。
						</div>
</div>
					</div>
				...
				<div id="part1" class="leaf one">
					...
					<tr>
					<td style="font-size: 17px;color: blue;padding-top: 20px;" valign="top">contect me:</td>
					<td align="left" style="font-size: 14px;color: blue;">
					© 2015 University of AY | fly, Ye
					</td>
					</tr>
					<tr>
					<td>email:</td>
					<td style="font-size: 17px;color: blue;">feiyang1232012@163.com</td>
					</tr>
					
					<tr>
					<td>技术支持:</td>
					<td style="font-size: 17px;color: blue;">QQ:469688915</td>
					</tr>
					...
					<div id="divHeght">
						...
						<div style="float: right; width: 83%;" id="framecenter">
							...
							还拥有操作日志的查看功能。
									...
									优化：
									<div style="padding-left: 20px;">不在dao层创建session方法来进行数据CRUD,
									用mapper来代替dao,由mybaits自动管理各事务的操作,大大减少代码开发时间.
									</div><div style="padding-left: 20px;">
									开发采用了maven管理工具,不再使用传统的web方式,所有jar所由maven管理!
									</div>
									技术要点：
									<div style="padding-left: 20px;">
									1：此版本采用ajax+js分页,有点模仿ligerui的分页实现
									...
									8：<font color="blue">支持oracle分页实现</font><br>
									9：........<br>
								</div>
